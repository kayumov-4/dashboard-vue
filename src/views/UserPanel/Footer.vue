<template>
  <footer class="h-[540px]">
    <div class="container text-white">
      <div class="pb-[89px]">
        <ul class="flex items-center pt-[132px]">
          <li class="w-[477px]">
            <a class="text-[25px] font-[RevaliaRegular]" href="#">webhub.uz</a>
          </li>
          <li class="font-[RowdiesBold] text-[25px] ml-[130px]">Quick Links</li>
          <li class="font-[RowdiesBold] text-[25px] ml-[200px]">Contact us</li>
        </ul>
        <div class="flex mt-[95px]">
          <p class="max-w-[477px] font-[SairaRegular]">
            Veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
            ea commodo consequat. Duis aute irure dolor in reprehenderit in
            voluptate velit esse cillum dolore eu fugiat nulla pariatur.
          </p>
          <div
            class="w-[205px] flex flex-wrap text-[18px] font-[SairaMedium] gap-x-[50px] gap-y-[22px] ml-[130px]"
          >
            <p>About</p>
            <p>Blog</p>
            <p>Course</p>
          ...
          <div class="ml-[146px]">
            <a class="flex items-center gap-x-[25px]" href="#"
              ><svg
            ...
            <a class="flex items-center gap-x-[25px] mt-[22px]" href="#"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
                height="16"
          ...
          <a class="flex gap-x-[25px] ml-[100px]" href="#"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="21"
              height="20"
      ...
      <div
        class="flex items-center justify-between pt-[40px] border-t border-[rgba(255,255,255,0.32)]"
      >
